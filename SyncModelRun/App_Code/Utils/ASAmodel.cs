...
{    
    public class OILMODEL
    {
        ...
        public class oilobject
        {
            ...
            public int daynight;   //1 after sunrise and before sunset, 0 night
            ...
            public oilobject(Single o_lon, Single o_lat, Single o_z, int o_nwhere, Single o_mass, Single o_radius,
                Single o_thickness, Single o_viscosity, Single o_watercontent, Single o_flashpoint, int o_daynight)
            {
                ...
                if (nwhere == 21)  //try to remove those spillet around 0,0 which  might be a bug in oilmodel.exe? XP 7/17/2011
                {
                ...
                if (nwhere == 0 && mass == 0 && thickness == 0)  //remove other point for drawing
                {
                    lon = -9999;
                    lat = -9999;
